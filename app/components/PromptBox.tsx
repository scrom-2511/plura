...
const PromptBox = ({ prompt, setPrompt, handleOnClick }: PromptBoxProps) => {
  ...
  return (
    ...
    <div className="col-span-4 lg:col-span-2 lg:col-start-2 bg-input border border-input-border rounded-full flex items-center px-6 py-2 shadow-lg transition-all focus-within:ring-2 focus-within:ring-accent/50 focus-within:border-accent mt-2">
